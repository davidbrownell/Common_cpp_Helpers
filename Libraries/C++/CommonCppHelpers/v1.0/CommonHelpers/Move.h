...
#define MOVE_Impl2(ClassName, Members, Bases, Flags)    MOVE_Impl2_Delay(MOVE_Impl3) BOOST_PP_LPAREN() ClassName, BOOST_PP_NOT(BOOST_VMD_IS_EMPTY(Members BOOST_PP_EMPTY())), Members, BOOST_PP_NOT(BOOST_VMD_IS_EMPTY(Bases BOOST_PP_EMPTY())), Bases, BOOST_PP_TUPLE_ENUM(Flags) BOOST_PP_RPAREN()
