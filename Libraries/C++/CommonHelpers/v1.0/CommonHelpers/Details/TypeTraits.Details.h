...
#else
#   define CREATE_HAS_TYPE_CHECKER_Impl2(Typename, Args)                    BOOST_PP_EXPAND(CREATE_HAS_TYPE_CHECKER_Impl3 BOOST_PP_LPAREN() Typename BOOST_PP_COMMA() BOOST_PP_TUPLE_REM_CTOR(Args) BOOST_PP_RPAREN())
#endif
...
#else
#   define CREATE_HAS_METHOD_CHECKER_Impl2(MethodName, Signature, Args)     BOOST_PP_EXPAND(CREATE_HAS_METHOD_CHECKER_Impl3 BOOST_PP_LPAREN() MethodName BOOST_PP_COMMA() Signature BOOST_PP_COMMA() BOOST_PP_TUPLE_REM_CTOR(Args) BOOST_PP_RPAREN())
#endif
...
#define CREATE_HAS_METHOD_CHECKER_Impl_Strict(MethodName, Signature, StructName, AsStaticBool, TemplateTypename, IsConst, IsStatic)                                                                                     \
    ...
    struct BOOST_PP_CAT(StructName, Impl) {                                                                                                                                                                             \
        template <typename TemplateTypename, BOOST_PP_IDENTITY Signature ()> struct dummy;                                                                                                                              \
                                                                                                                                                                                                                        \
        template <typename HasMethodCheckerImplInternalArgumentT> static std::true_type Check(dummy<HasMethodCheckerImplInternalArgumentT, CREATE_HAS_METHOD_CHECKER_Impl_Strict_AddressOfImpl(MethodName)> const *);   \
    ...
    private:                                                                                                                                                                                                                                                                                                                                                \
        ...
        struct DeduceHasMember {                                                                                                                                                                                                                                                                                                                            \
            ...
            struct SFINAEHelper {                                                                                                                                                                                                                                                                                                                           \
                                                                                                                                                                                                                                                                                                                                                            ...
                                                                                                                                                                                                                                                                                                                                                            \
            template <typename T0> static std::false_type Evaluate(T0 const *, SFINAEHelper<void (BOOST_PP_IIF(IsStatic, BOOST_PP_EMPTY, BOOST_PP_IDENTITY(Mixin::))() *)(DeduceHasMemberDummy) BOOST_PP_IIF(IsConst, BOOST_PP_IDENTITY(const), BOOST_PP_EMPTY)(), CREATE_HAS_METHOD_CHECKER_Impl_Standard_AddressOfImpl(MethodName)> const * =nullptr);    \
            static std::true_type Evaluate(...);                                                                                                                                                                                                                                                                                                            \
                                                                                                                                                                                                                                                                                                                                                            \
            static bool const value = std::is_same<std::true_type, decltype(Evaluate(static_cast<Derived BOOST_PP_IIF(IsConst, BOOST_PP_IDENTITY(const), BOOST_PP_EMPTY)() *>(nullptr)))>::value;                                                                                                                                                           \
        };                                                                                                                                                                                                                                                                                                                                                  \
                                                                                                                                                                                                                                                                                                                                                            \
...
#if (defined _MSC_VER && !defined __clang__)
    // MSVC needs parens when taking the address of the method when supporting operators; Clang gets confused when it sees these parens.
#   define CREATE_HAS_METHOD_CHECKER_Impl_Standard_AddressOfImpl(MethodName)    &(T0::MethodName)
#else
#   define CREATE_HAS_METHOD_CHECKER_Impl_Standard_AddressOfImpl(MethodName)    &T0::MethodName
#endif
